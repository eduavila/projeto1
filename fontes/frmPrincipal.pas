...
uses  frmClientes, frmFornecedores, frmSobre,
  frmCalendario, AberturaFrm, frmProdutos, frmGrafico;
...
procedure TfrmPricipal.SpeedButton3Click(Sender: TObject);
begin
...
procedure TfrmPricipal.SpeedButton5Click(Sender: TObject);
begin
